...
const AllCategories = ({ onBack, onViewCategory }) => {
  ...
  const productsItem = [
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/22e8f5e19f8a469193ec854927e9c5a6/49c49bd0e5d9628f98411f3efec9b390d71c3b23?placeholderIfAbsent=true",
    ...
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/22e8f5e19f8a469193ec854927e9c5a6/46ea9b8772bcd4cf328c4bc33347a519450944be?placeholderIfAbsent=true",
      name: "Customized logo Design for Men and Women Classic and Versatile",
      price: "₹130/10 pieces",
      supplier: "Suzhou Dreamcolor Textile Co., Ltd.",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/22e8f5e19f8a469193ec854927e9c5a6/fa3419cc3d8104c7ff988f3c3aaf852fcc9292ae?placeholderIfAbsent=true",
      name: "Customized logo Design for Men and Women Classic and Versatile",
      price: "₹250/10 pieces",
      supplier: "Suzhou Dreamcolor Textile Co., Ltd.",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/22e8f5e19f8a469193ec854927e9c5a6/b0ae075f9f425d442243b0f283a62ee2e52f906d?placeholderIfAbsent=true",
      name: "Customized logo Design for Men and Women Classic and Versatile ",
      price: "₹430/10 pieces",
      supplier: "Suzhou Dreamcolor Textile Co., Ltd.",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/22e8f5e19f8a469193ec854927e9c5a6/a4a785192a0802a4c4ec2437065d12f9c4a0c091?placeholderIfAbsent=true",
      name: "Customized logo Design for Men and Women Classic and Versatile",
      price: "₹130/10 pieces",
      supplier: "Suzhou Dreamcolor Textile Co., Ltd.",
    },
        ...
        <div className="w-full h-full ml-[268px] max-md:w-full max-md:ml-0">
          <div className="w-full mt-[35px] max-md:max-w-full max-md:mt-10">
            ...
            <div className="flex items-center gap-[40px_100px] justify-between flex-wrap mt-[30px] max-md:max-w-full max-md:mr-[3px]">
              <h2 className="text-[#050505] text-xl font-bold self-stretch my-auto cursor-pointer">
              <span  onClick={onBack}>&lt;</span><span>Categories</span> 
              </h2>
            </div>

            <div className="" onClick={onViewCategory}>
